---
layout: default
title: List Counter — Privacy Policy
description: Privacy policy for the List Counter Android app by Dash Fusion.
---
...
- **App name:** List Counter
- **Developer:** Dash Fusion
- **Support email:** dash.fusion@outlook.com
- **App listing:** Google Play (`com.dashfusion.listcounter`)
...
app — Android removes the local database with it.
...
AdMob does **not** receive your counter data, your history, or your
...
List Counter is not directed to children under 13 and is not designed for
...
changes will be flagged in an in-app notice as well.
