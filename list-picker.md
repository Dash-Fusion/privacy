---
layout: default
title: List Picker — Privacy Policy
description: Privacy policy for the List Picker Android app by Dash Fusion.
---

# List Picker — Privacy Policy
...
List Picker is an offline-first decision-maker app (random picker, wheel
spinner, team divider, coin/dice/number tools). We do **not** create accounts,
...
- **App name:** List Picker
- **Developer:** Dash Fusion
- **Support email:** dash.fusion@outlook.com
- **App listing:** Google Play (`com.dashfusion.listpicker`)
...
- Your saved lists and their items (the names you type in)
- No-repeat ("raffle") pool state — which items are still in the running
- Pick history per list and recent results for the quick tools, with local
  timestamps
- App preferences: theme (system/light/dark)

You can export this data as a JSON file at any time via
**Settings → Back up my lists**, and import it again via
**Settings → Restore from backup**. You can wipe all of it by uninstalling
the app — Android removes the local database with it.

We have no servers and no cloud storage. We cannot recover your data if you
lose your device.
...
AdMob does **not** receive your lists, your pick history, or your
...
- **Internet** — solely so the Google Mobile Ads SDK can fetch ads.
  Disabling Wi-Fi/data simply means no ads load; the app still works fully
  offline.

The app does **not** hold standing access to your location, contacts,
microphone, photos, or files. When you back up or restore, the app uses your
device's own share sheet / file picker and only touches the single file you
choose.

## Children

List Picker is not directed to children under 13 and is not designed for
...
- **Export your data** — Settings → Back up my lists (writes a JSON file you
  control)
...
we will update this page and bump the "Last updated" date above.
